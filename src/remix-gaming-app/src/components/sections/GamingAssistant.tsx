          ...
          content: (
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500 font-light leading-relaxed">
                Verified aspect tag <code className="text-blue-600 bg-blue-50 px-1 py-0.5 rounded">liveops_campaign_policy_aspect</code> on target table <code className="text-slate-700 bg-slate-100 px-1 py-0.5 rounded">gaming_gold.gold_player_360</code>:
              </p>
