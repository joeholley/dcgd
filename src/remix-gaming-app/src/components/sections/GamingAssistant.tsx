...
export function GamingAssistant({ isOpen, onToggle }: { isOpen: boolean; onToggle: () => void }) {
  ...
  const handleSend = async (customMsg?: string) => {
    ...
    const initialSteps: ChatStep[] = [
      ...
      { id: 2, title: "Aspect Tag Verification", detail: "Verifying gaming-campaign-policy-aspect compliance...", status: "pending" },
    ...
    setTimeout(() => {
      setActiveSteps([
        ...
        { id: 2, title: "Aspect Tag Verification", detail: "Verifying gaming-campaign-policy-aspect compliance...", status: "in_progress" },
        { id: 3, title: "BigQuery SQL Execution", detail: "Executing gold_player_360 query via ADC...", status: "pending" },
      ]);
    }, 400);
          ...
          content: (
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500 font-light leading-relaxed">
                Verified aspect tag <code className="text-blue-600 bg-blue-50 px-1 py-0.5 rounded">gaming-campaign-policy-aspect</code> on target table <code className="text-slate-700 bg-slate-100 px-1 py-0.5 rounded">gaming_gold.gold_player_360</code>:
              </p>
