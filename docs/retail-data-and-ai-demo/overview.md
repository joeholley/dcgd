Listed directory retail-data-and-ai-demo
...
This repository (**`retail-data-and-ai-demo`**) contains Infrastructure-as-Code (Terraform) and BigQuery stored procedures designed to automatically provision and populate a **Google Cloud Retail Data & AI Demo** environment.
...
#### 1. API Enablement Module ([project-setup](../../src/retail-data-and-ai-demo/infrastructure/project-setup))
...
*Files:* [main.tf](../../src/retail-data-and-ai-demo/infrastructure/project-setup/main.tf), [service-api.tf](../../src/retail-data-and-ai-demo/infrastructure/project-setup/service-api.tf)

#### 2. BigQuery Data Architecture ([bigquery.tf](../../src/retail-data-and-ai-demo/infrastructure/terraform/bigquery.tf))
...
#### 3. AI Data Generation Pipelines ([bigquery-routines](../../src/retail-data-and-ai-demo/infrastructure/terraform/bigquery-routines))
- **Identity Generation** ([generate-persons.sql.tftpl](../../src/retail-data-and-ai-demo/infrastructure/terraform/bigquery-routines/generate-persons.sql.tftpl)): Executes `AI.GENERATE(...)` against Vertex AI endpoint models to synthesize realistic names and emails.
- **Customer Population** ([populate-customer-tables.sql.tftpl](../../src/retail-data-and-ai-demo/infrastructure/terraform/bigquery-routines/populate-customer-tables.sql.tftpl)): Distributes identities between local GCP tables (`customers`) and simulated AWS tables (`aws_customers`) with randomized LTVs and order histories.
- **Cart Generation** ([generate-carts.sql.tftpl](../../src/retail-data-and-ai-demo/infrastructure/terraform/bigquery-routines/generate-carts.sql.tftpl)): Builds shopping cart records associated with generated customers.